...
def list_books(repository: BookRepository = Depends(build_book_repository)):
...
def get_book(book_id: str, repository: BookRepository = Depends(build_book_repository)):
